...
- [x] **T01: Production YAML — WiFi, OTA, API, diagnostics** `est:30m`
...
- [x] **T02: Compile gate — firmware builds clean** `est:15m`
...
- [x] **T03: Mock frame tests — exercise decode pipeline with captured data** `est:45m`
...
- [x] **T04: YAML validation tests — cover all new config sections** `est:20m`

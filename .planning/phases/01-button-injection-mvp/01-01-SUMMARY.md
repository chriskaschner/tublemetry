...
plan: 01
subsystem: decode
tags: [python, pytest, 7-segment, rs485, tdd, display-decoder]
...
# Tech tracking
tech-stack:
  added: [python, pytest, uv, hatchling]
  patterns: [tdd, dumb-decoder, confidence-tracking, immutable-dataclass]
...
patterns-established:
  - "Confidence tracking: every decoded value carries confirmed/unverified tag"
  - "Dumb decoder: state machine reports display faithfully, zero business logic interpretation"
  - "Temperature persistence: last valid temperature survives non-temperature display states"

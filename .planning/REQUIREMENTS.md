...
- [ ] **DISP-01**: ESP32 decodes RS-485 display stream to read current water temperature
- [ ] **DISP-02**: Current temperature populates HA climate entity (full thermostat card with current + target)
